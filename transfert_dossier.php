...
<center>
  <?php
          $id=$_SESSION['id'];
            $requete1=$connexion->prepare("
                  SELECT DATE_P, DAY_P, DESTINATION FROM programme__transfert Where ID_DOS=$id");
            $requete1->execute();
  ...
  <tbody>
    ...
    ?>
    <tr>
      <form id="formulaire" method="POST" action="addtransfert.php?id=<?php echo $id; ?>">
        <td>--</td>
        <td><input name="dateP" class="form-control" type="date"></input></td>
